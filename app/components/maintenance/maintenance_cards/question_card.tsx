...
interface Card extends ParamQuestions {
    ...
    handleModifyQuestion: (question: ParamQuestions) => Promise<void>;
}
...
const QuestionCard: React.FC<Card> = (promp: Card) => {  
    const onDeleteClick = async () => {
      ...
      const onModifyClick = async () => {
        await promp.handleModifyQuestion(promp);
      };
    return (
        <div className="bg-blue-1000 w-full flex flex-wrap gap-5 my-2 rounded-md px-5 p-2 items-center">
            ...
            <div className="w-full md:w-auto flex justify-center md:justify-start">
                <div className='bg-purple-400 flex gap-5 rounded-2xl text-white cursor-pointer m-2 justify-center p-3' onClick={onModifyClick}>
                    <Link href={'/home_page/maintenance/mainte_questions/questions_form'}>
